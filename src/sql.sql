ALTER TABLE intervention_user CHANGE id id INT AUTO_INCREMENT NOT NULL;
     ...
     ALTER TABLE control_tech CHANGE id id INT AUTO_INCREMENT NOT NULL;
     ALTER TABLE control_tech ADD CONSTRAINT FK_74526EA74A4A3511 FOREIGN KEY (vehicule_id) REFERENCES vehicule (id);
     ...
     ALTER TABLE assurance CHANGE id id INT AUTO_INCREMENT NOT NULL;
     ALTER TABLE assurance ADD CONSTRAINT FK_386829AE4A4A3511 FOREIGN KEY (vehicule_id) REFERENCES vehicule (id);
